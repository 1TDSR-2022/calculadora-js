...
// const elementosForm = document.querySelector('#frmCalc');
...
// Passando paramentros pra a função
...
document.querySelector('#numero1Id').addEventListener('click', () => {
    ...
    //Chamando a função para colocar no visor
    colocarNoVisor(this.value);

})

document.querySelector('#numero2Id').addEventListener('click', () => {
...
function colocarNoVisor (valor){
    //Vamos passar o value dos inputs botton1 e botton2 para o visor
    const visor = document.querySelector('#visorId');
    if (visor.value == '0'){
        visor.value = valor;
    }else{
