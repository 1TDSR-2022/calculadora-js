...
//Recuperando elementos do DOM com querySelector
//const elementoResultado = document.querySeconst elementoResultado = document.querySelector('#frmCalc input');coconsole.log(elementoResultado.value);

//Botão1 adcionando um valor no input.
